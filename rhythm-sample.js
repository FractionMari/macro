...
var RhythmSample = function() {
    loadSounds(this, {
        kick: 'https://webaudioapi.com/samples/rhythm/kick.wav',
        snare: 'https://webaudioapi.com/samples/rhythm/snare.wav',
        hihat: 'https://webaudioapi.com/samples/rhythm/hihat.wav'
    });
  };
...
var tempo = tempoValue; // BPM (beats per minute)
