...
///9. februar: i stedet for volum blir det en effekt!
...
// Den første her er volumet! husk det
	function processDiff(diffImageData) {
		...
		for (var i = 0; i < rgba.length; i += 4) {
			...
			// var xValue = (((i * (-1)) + 40) / 8) / 50;	// calcluatin value for volume
			//gainNode2.gain.value = xValue;
			var xValue = ((i * (-1)) + 40) / 8; // calculating value for biquad filter
